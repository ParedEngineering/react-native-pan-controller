...
type ModePropType = 'decay' | 'snap' | 'spring-origin'
type OvershootPropType = 'spring' | 'clamp'
...
type Props = {
    ...
    xMode: string,
    yMode: string,
    snapSpacingX: number, // TODO: also allow an array of values?
    snapSpacingY: number,
...
export default class CustomPanController extends Component<any, Props, State> {
